...
type OAuth struct {
	...
	// if provided, the (opaque) access token received from the oauth endpoint
	// will be validated against this endpoint
	IntrospectionUrl string `protobuf:"bytes,8,opt,name=introspection_url,json=introspectionUrl,proto3" json:"introspection_url,omitempty"`
	...
	TokenIntrospectionCacheTimeout *time.Duration `protobuf:"bytes,9,opt,name=token_introspection_cache_timeout,json=tokenIntrospectionCacheTimeout,proto3,stdduration" json:"token_introspection_cache_timeout,omitempty"`
	XXX_NoUnkeyedLiteral           struct{}       `json:"-"`
	XXX_unrecognized               []byte         `json:"-"`
	XXX_sizecache                  int32          `json:"-"`
}
...
var fileDescriptor_043e68ecbb4b7f5e = []byte{
	...
	,
	...
	,
}
